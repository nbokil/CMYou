...
class CommitmentsControllerTest < ActionController::TestCase
  ...
  test "should create commitment" do
    assert_difference('Commitment.count') do
      post :create, commitment: { organization_id: @commitment.organization_id, student_id: @commitment.student_id }
    end
  ...
  test "should update commitment" do
    patch :update, id: @commitment, commitment: { organization_id: @commitment.organization_id, student_id: @commitment.student_id }
    assert_redirected_to commitment_path(assigns(:commitment))
  end
